...
# Defining the colors for the background and text.
co0 = "#444466"  # Preta
co1 = "#feffff"  # branca
co2 = "#6f9fbd"  # azul
fundo = "#484f60"
...
# Creating a separator between the two frames.
...
def info():
    """
    It gets the current price of Bitcoin in USD, EUR, AOA, and BRL, and displays it in the GUI
    """
...
l_nome = Label(frame_principal, text="Cotaçao Bitcoin", height=1, padx=0, relief="flat", anchor="center", font=('Arial 20 '), bg=co1, fg=co2)
